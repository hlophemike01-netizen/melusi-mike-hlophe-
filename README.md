...
| --- | --- |
| [ARCHITECTURE.md](./docs/ARCHITECTURE.md) | Layers, directory structure, data flow, where each rule is enforced |
| [DATABASE.md](./docs/DATABASE.md) | Every table, column, index and constraint, and why |
| [SECURITY.md](./docs/SECURITY.md) | RLS policies, threat model, the security tests |
| [PRIVACY.md](./docs/PRIVACY.md) | Data inventory, retention, user controls, what staff can see |
| [LOCATION_MODEL.md](./docs/LOCATION_MODEL.md) | The location lifecycle, coarsening, k-anonymity, browser limits |
| [DEPLOYMENT.md](./docs/DEPLOYMENT.md) | Supabase + Vercel setup, environment variables, scheduled jobs |
| [diagrams/](./docs/diagrams) | The three diagrams the docs above embed, as standalone SVGs |
| [index.html](./docs/index.html) | A browsable index of everything below — open it in a browser |
...
[DEPLOYMENT.md](./docs/DEPLOYMENT.md); the short version:
...
See [SECURITY.md](./docs/SECURITY.md#the-security-test-suite).
...
- **It does not track location in the background.** Browsers stop or heavily
  ...
  [LOCATION_MODEL.md](./docs/LOCATION_MODEL.md#the-background-location-limitation).
...
listed in [DEPLOYMENT.md](./docs/DEPLOYMENT.md#before-a-public-launch).
